...
wamd64: $(objects)
	GOOS=windows GOARCH=amd64 go build -o $(PRODPATH)/$(APPNAME)_$(RELEASE)_windows-amd64.exe $(objects)
w386: $(objects)
	GOOS=windows GOARCH=386 go build -o $(PRODPATH)/$(APPNAME)_$(RELEASE)_windows-386.exe $(objects)